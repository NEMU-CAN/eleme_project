...
public final class ServiceValidator {
     ...
     * 校验可选值在存在时必须为正数。
     */
    public static void requireOptionalPositive(Integer value, String field) {
        if (value != null && value <= 0) {
            throw ApiException.badRequest(field, "必须大于 0");
        }
    }
     ...
     * 校验值只能是 0 或 1。
     */
    public static void requireZeroOrOne(Integer value, String field) {
     ...
     * 校验可选值在存在时只能是 0 或 1。
     */
    public static void requireOptionalZeroOrOne(Integer value, String field) {
        if (value != null && value != 0 && value != 1) {
            throw ApiException.badRequest(field, "只允许 0 或 1");
        }
    }
     ...
     * 校验字符串长度不超过上限。
     */
    public static void requireMaxLength(String value, String field, int maxLength) {
